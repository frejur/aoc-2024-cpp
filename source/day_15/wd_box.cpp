...
aoc24_15::Wide_box::~Wide_box()
{
	std::vector<Box_new*> unique_boxes{Wide_box::linked_boxes()};
...
aoc24_15::Box_new** aoc24_15::Wide_box::linked_box_address(
...
std::vector<aoc24_15::Box_new*> aoc24_15::Wide_box::linked_boxes() const
{
...
std::vector<aoc24_15::Box_new*> aoc24_15::Wide_box::linked_boxes(
    aoc24::Direction dir) const
{
	std::vector<Box_new*> unique_boxes;
	for (auto linked : edge_tiles_) {
...
std::unique_ptr<aoc24_15::Box_new> aoc24_15::Wide_box_factory::create_box(
    Warehouse& parent_grid, int pos_x, int pos_y)
{
	return std::unique_ptr<Box_new>(new Wide_box{&parent_grid, pos_x, pos_y});
}
